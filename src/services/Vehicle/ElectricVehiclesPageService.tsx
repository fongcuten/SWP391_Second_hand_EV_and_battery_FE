...
export const ListPostService = {
    async getSalePosts(
        ...
        try {
            ...
            // Handle location
            if (filters.selectedProvinceCode) params.provinceCode = filters.selectedProvinceCode;
            if (filters.selectedDistrictCode) params.districtCode = filters.selectedDistrictCode;
            ...
            if (filters.priceRange) {
                if (filters.priceRange.includes('+')) {
                    params.minPrice = parseInt(filters.priceRange.replace('+', '')) * 1000000;
                } else {
            ...
            const response = await api.get<PageableResponse<ListPostSummary>>("/api/sale-posts/vehicles", {
                params,
            });
    ...
    async getBatteryPosts(
        ...
        try {
            ...
            const response = await api.get<PageableResponse<ListPostSummary>>("/api/sale-posts/batteries", {
                params,
            });

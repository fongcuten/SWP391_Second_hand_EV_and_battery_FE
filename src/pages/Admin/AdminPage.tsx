    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="hidden sm:inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800">
            Vai trò: Admin
          </span>
          <button
      ...
      {activeTab === "dashboard" && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <StatCard label="Bài đăng hoạt động" value="327" delta="+5 hôm nay">
            ...
            <StatCard label="Doanh thu" value="₫12,5M" delta="+7% tháng này">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-500">{c.count} bài</span>
                  </li>
                ))}
              </ul>
            </SectionCard>
        ...
        <div className="space-y-6">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <div className="text-sm text-gray-600 mb-2">Đăng ký mới</div>
                <BarChart values={[20, 25, 30, 22, 40, 35, 50, 45, 60, 58]} />
              </div>
              <div>
                <div className="text-sm text-gray-600 mb-2">
                  Tỷ lệ duyệt bài
                </div>
                <MiniTrend points={[60, 62, 64, 63, 65, 67, 70, 72, 73, 75]} />
              </div>
            </div>
          </SectionCard>
      ...
      {activeTab === "posts" && (
        <SectionCard
          ...
          right={<div className="text-sm text-gray-500">3 bài chờ duyệt</div>}
        >
          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <div key={i} className="border rounded-lg p-4">
                <div className="font-medium">Bài đăng #{i}</div>
                <div className="text-sm text-gray-500 mt-1">Xe điện / Pin</div>

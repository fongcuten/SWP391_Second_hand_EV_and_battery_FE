...
const CheckoutSuccessPage = () => {
  ...
  const processPayment = async () => {
    ...
    const inspectionOrderIdStr = localStorage.getItem(
    ...
    try {
      ...
      setMessage(
        "Thanh toán thành công! Đơn kiểm duyệt của bạn đã được xác nhận."
      );
      toast.success("Thanh toán thành công — đơn kiểm duyệt đã được xác nhận.");
    } catch (error: any) {
